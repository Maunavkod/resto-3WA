...
class FrontController
{
            ...
            [
                ...
                'variables' =>
                    [
                        ...
                        'wwwUrl'     => str_replace('/index.php', '', $_SERVER['SCRIPT_NAME']),
                    ],
            ];
    }
    ...
    public function buildContext(Configuration $configuration)
    {
        ...
        $filters = $configuration->get('library', 'intercepting-filters', []);
    ...
    public function run(Configuration $configuration)
    {
        ...
        $this->viewData['template'] = $controller::VIEW . 'View.phtml';
    }
}
